...
var _ErrorScreen = _interopRequireDefault(require("./screens/ErrorScreen404.js"));

var _HomeScreen = _interopRequireDefault(require("./screens/HomeScreen.js"));

var _ProductScreen = _interopRequireDefault(require("./screens/ProductScreen.js"));

var _ProductsScreen = _interopRequireDefault(require("./screens/ProductsScreen.js"));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          parseUrl = (request.resorce ? "/".concat(request.resorce) : "/") + (request.id ? "/:id" : "") + (request.action ? "/".concat(request.action) : "");
          screen = routes[parseUrl] ? routes[parseUrl] : _ErrorScreen["default"];
